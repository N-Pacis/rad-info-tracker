...
public interface IPatientAppointmentRepository extends JpaRepository<PatientAppointment, UUID> {
    ...
    Page<PatientAppointment> findAllByDateAndTechnician(LocalDate date, UserAccount technician, Pageable pageable);

    Page<PatientAppointment> findAllByDateAndRadiologist(LocalDate date, UserAccount radiologist, Pageable pageable);
